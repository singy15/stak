...
$(document).ready(function() {
  //createEditor('/config/layouteditor.xml');
  //


  $.ajax({
    type: "GET",
    url: "/whiteboard/default",
    ...
    error: function() {
      console.log("Get default whiteboard error!!!");
    },
    dataType: "json"
  });
...
function loadGraph(xml) {
  editor.setGraphXml(mxUtils.parseXml(xml).documentElement);
}
